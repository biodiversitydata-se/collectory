...
<div class="row">
    <div id="baseForm" class="col-md-8">
        <g:form action="searchForRepatResources" controller="manage">
            ...
            <div class="form-group">
                <label for="installationKey">GBIF installation key to exclude</label>
                <g:field type="text" name="installationKey" class="form-control" value="${configuration.installationKey}" />
            </div>
            <div class="form-group hide">
